 ...
 * UartTerminal.h
 *
 *  Created on: 15 jan. 2020 ã.
 *      Author: Taras.Melnik
 */

#ifndef LIB_UARTTERMINAL_H_
#define LIB_UARTTERMINAL_H_
...
class UartTerminal : public UartApi {
public:
    UartTerminal();
...
extern UartTerminal uartTerm;

#endif /* LIB_UARTTERMINAL_H_ */
