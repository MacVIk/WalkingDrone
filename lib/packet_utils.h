...
static const uint8_t MAX_PACKET_BYTES = 255;
static const uint8_t HEADER_SIZE = 3;
static const uint8_t HEADER[3] = {0xFF, 0xFF, 0xFD}; 
static const uint8_t PREFIX_SIZE = 8;
static const uint8_t CHECKSUM_SIZE = 2;
static const uint8_t BASE_PACKET_SIZE = 8 + 2; // Prefix + checksum

static const uint8_t ID_ADDR = 4;
static const uint8_t LENGTH_L_ADDR = 5;
static const uint8_t LENGTH_H_ADDR = 6;
static const uint8_t INST_ADDR = 7;
...
uint8_t SetChecksum(uint8_t* data, uint16_t num_parameters);
